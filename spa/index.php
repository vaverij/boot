...
<html lang="en" class="no-js">
            ...
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://vk.com/sqrrel">photos</a></li>
                        <li><a href="https://www.youtube.com/channel/UCWwVAALpwkv2_HsAzCTNBig?view_as=subscriber">videos</a></li>
                    </ul>
                    </li>
    ...
    <div class="promo-block">
        <div class="container">
            ...
            <a class="btn-theme btn-theme-md btn-white-bg text-uppercase" href="https://vk.com/sqrrel" title="Gallery">Gallery</a>
    ...
    <div class="photo">
        <div class="container">
            ...
            <h2>Photos</h2>
                ...
                <br>
                <a class="btn-theme btn-theme-md btn-default-bg text-uppercase" href="https://vk.com/sqrrel" title="Portfolio">Portfolio</a>
                <script>
                var slideIndex = 1;
                showDivs(slideIndex);
        ...
        <div class="container">
            <div class="row" align="center">
                <h2>Prices</h2>
                    ...
                    <div class="blog-card pr">
                    <div class="title-content">
                        <h3>Wedding</h3>
                        <hr />
                        <div class="intro">The wedding is the most beautiful and quivering holiday. The photos will help to remember this moment. <br> Price: from 100 EUR.</div>
                    </div>
                    ...
                    <div class="blog-card pr2">
                    <div class="title-content">
                        <h3>Portrait</h3>
                        <hr />
                        <div class="intro">Individual approach to each client. Joint thinking of ideas. <br> Price: from 30 EUR.</div>
                    </div>
                    ...
                    <div class="blog-card pr3">
                    <div class="title-content">
                        <h3>Video</h3>
                        <hr />
                        <div class="intro">From thinking up ideas to implementation. It is possible to shoot different formats (Facebook, YouTube). <br> Price: for agreement.</div>
                    </div>
